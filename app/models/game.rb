...
class Game < ActiveRecord::Base
	...
	def game_won?
		return false if @moves.nil? or (@moves.size < 5)
		
		# horizontal wins
		return true if win_found("game_id = ? and player_id = ? and ((x_axis = 0 and y_axis = 0) or (x_axis = 1 and y_axis = 0) or (x_axis = 2 and y_axis = 0))")
		return true if win_found("game_id = ? and player_id = ? and ((x_axis = 0 and y_axis = 1) or (x_axis = 1 and y_axis = 1) or (x_axis = 2 and y_axis = 1))")
		return true if win_found("game_id = ? and player_id = ? and ((x_axis = 0 and y_axis = 2) or (x_axis = 1 and y_axis = 2) or (x_axis = 2 and y_axis = 2))")
		
		# vertical wins
		return true if win_found("game_id = ? and player_id = ? and ((x_axis = 0 and y_axis = 0) or (x_axis = 0 and y_axis = 1) or (x_axis = 0 and y_axis = 2))")
		return true if win_found("game_id = ? and player_id = ? and ((x_axis = 1 and y_axis = 0) or (x_axis = 1 and y_axis = 1) or (x_axis = 1 and y_axis = 2))")
		return true if win_found("game_id = ? and player_id = ? and ((x_axis = 2 and y_axis = 0) or (x_axis = 2 and y_axis = 1) or (x_axis = 2 and y_axis = 2))")
		
		# diagonal
		return true if win_found("game_id = ? and player_id = ? and ((x_axis = 0 and y_axis = 0) or (x_axis = 1 and y_axis = 1) or (x_axis = 2 and y_axis = 2))")
		return true if win_found("game_id = ? and player_id = ? and ((x_axis = 2 and y_axis = 0) or (x_axis = 1 and y_axis = 1) or (x_axis = 0 and y_axis = 2))")
	...
	def does_context_allow_move(player)
		...
		# why this works and @winner does not I do not understand
